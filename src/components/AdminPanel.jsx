...
const AdminPanel = () => {
  ...
  return (
    <div className={`space-grotesk  ${userData.length <= 4 && "lg:h-[100vh]"}`}>
      ...
      <div><NavLink to={"/sign-in"} onClick={handleSignOut} className='underline md:hidden block'>Çıxış et</NavLink></div>
